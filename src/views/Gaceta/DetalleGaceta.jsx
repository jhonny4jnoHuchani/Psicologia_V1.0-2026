...
const PdfViewer = ({ documentUrl, title, primaryColor }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div className="flex items-center gap-2">
          <button
            ...
            style={viewMode === "preview" ? { background: `linear-gradient(135deg, ${primaryColor}, var(--color-secondary, #a75c06))` } : {}}
          >
        ...
        <a
          ...
          style={{ 
            background: `linear-gradient(135deg, ${primaryColor}, var(--color-secondary, #a75c06))`,
            color: 'white'
          }}
        >
          <Download size={14} />
      ...
      {/* Visor del PDF */}
      <div className="relative bg-gray-100 rounded-2xl overflow-hidden shadow-2xl" style={{ minHeight: '70vh' }}>
        {isLoading && (
